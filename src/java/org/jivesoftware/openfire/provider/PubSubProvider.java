...
public interface PubSubProvider {
	 ...
	 */
	 void createNode(PubSubService service, Node node);
	 ...
	 */
	 void updateNode(PubSubService service, Node node);
	 ...
	 */
	 boolean removeNode(PubSubService service, Node node);
	 ...
	 */
	 void saveAffiliation(PubSubService service, Node node,
			NodeAffiliate affiliate, boolean create);
	 ...
	 * @param create    True if this is a new affiliate.
	 */
	 void saveSubscription(PubSubService service, Node node,
	 ...
	 */
	 void removeSubscription(PubSubService service, Node node,
	 ...
	 */
	 DefaultNodeConfiguration loadDefaultConfiguration(
			PubSubService service, boolean isLeafType);
